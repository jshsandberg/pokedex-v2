        ...
        const fetchData = async () => {
            try {
                ...
                for (let i = 0; i < pokemon_entries.length; i++) {
                    ...
                    // Need to figure out 4th evolution
                    const chain = [
